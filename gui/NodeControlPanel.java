		...
		// construction sub-menu:
			...
			if (buttonLetter.equals("E")) {
				if (instance.isNodeCaptured(node) && settlement == null && !instance.isTooCloseToCity(node)
					&& (wall == null || (!wall.isUpgrading() && !wall.isBuildingSite())))
				{
			...
			if (buttonLetter.equals("Y")) {
				if (instance.isNodeCaptured(node) && settlement == null && instance.isNodeGoldVein(node) && (wall == null || (!wall.isUpgrading() && !wall.isBuildingSite()))) {
